...
const projects: Project[] = [
    ...
    faq: [
      {
        ...
        answer: '주류 중 유일하게 온라인판매가 가능한 전통주라는 키워드에 꽂혀 개발하게 되었습니다. MZ세대가 전통주에 대한 관심은 높지만 경험이 부족하여, 경험을 미리 시켜주고 공유하는 SNS를 기획했습니다.',
      },
      {
        question: '성능 개선 사례는 무엇인가요?',
        answer: '현재 위치 주변 피드 목록을 지도에 마커로 띄울 때 성능 저하가 발생하였습니다. 따라서, 디바운싱 + 프리패칭 + 디핑을 이용하여 피드 목록 조회를 현저히 감소시켰고, 이로 인해 지도 화면 프레임 드랍 현상이 해결되었습니다.',
      },
      {
  ...
  },
  {
    ...
    faq: [
      {
        question: '이 서비스를 왜 만들게 되었나요?',
        answer: '팀프로젝트를 할 때 일부 팀원이 참여하지 않고도 같은 점수를 받아가는 무임승차 문제를 해결하기 위해 기획하였습니다. Admin은 통게적 기준으로 판단된 무임승차자를 볼 수 있고 User는 팀프로젝트를 수행하며 프로젝트 관리 및 수행이 동시에 가능한 플랫폼을 기획했습니다.',
      },
      {
        question: 'FSD 아키텍처 선정 이유는 무엇인가요?',
        answer: '공모전 출품 주제가 Cloud-Native한 대규모 서비스 제작이였습니다. 따라서, 대규모 서비스를 위해 백엔드에서 MSA 아키텍처를 채용하였습니다. 프론트엔드는 바로 MFA 도입은 무리라고 생각하여, 기능 및 도메인 별로 세세히 나눌 수 있는 FSD 아키텍처를 도입했습니다. 또한, 확장될 모바일 서비스는 UI가 아예 다를 수 있어 BFF 아키텍처도 추가로 제안하였습니다.',
      },
      {
        question: '성능 개선 사례는 무엇인가요?',
        answer: '폰트 로딩 중 기본 폰트가 노출되어 화면 배치가 어긋나는 Layout Shift 문제가 발생했습니다. 따라서 최상위 레이아웃에 Splash 화면을 도입하여 문제를 해결하고 초기 렌더링 관련 UX를 개선시켰습니다.',
      },
      {
        question: '또 다른 성능 개선 사례는 무엇인가요?',
        answer: 'PDF 뷰어 페이지 관련하여 PDF 리소스 및 관련 라이브러리로 인해 초기 페이지 로딩 속도 저하 문제가 발생하였습니다. 따라서 next/dynamic을 활용한 lazy loading을 활용하여 초기 렌더링 시간 단축 및 PDF 뷰어 페이지 진입 속도를 향상시켰습니다.',
      },
      {
  ...
  },
  {
    ...
    faq: [
      ...
      },
      {
        question: '성능 개선 사례는 무엇인가요?',
        answer:
          '프로젝트 상세 모달에서 고해상도 이미지로 인해 해당 페이지 렌더링 지연 및 UX 저하 문제가 발생했습니다. 따라서, Vite에서 eager 설정을 통해 asset을 사전에 로딩하고, 초기 접속 시 Skeleton UI를 도입 및 Mition의 stagger animation delay를 적용하여 로딩 시간을 추가 확보하였습니다. 이로 인해 체감 성능을 극대화시키고 UX 안정성을 확보하였습니다.',
      },
      {
  ...
  },
  {
    ...
    faq: [
      ...
      {
        question: 'PM 및 리더로써 협업 시 문제는 무엇이였으며, 어떻게 해결하였나요?',
        answer:
